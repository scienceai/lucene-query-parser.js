  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "regexpr_term": parse_regexpr_term,
        "regexpr_char": parse_regexpr_char,
      ...
      function parse_term() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            result0 = result0 !== null ? result0 : "";
            if (result0 !== null) {
              result1 = parse_regexpr_term();
              if (result1 !== null) {
                result2 = parse_boost_modifier();
                result2 = result2 !== null ? result2 : "";
                if (result2 !== null) {
                  result3 = [];
                  result4 = parse__();
            ...
            if (result0 !== null) {
              result0 = (function(offset, op, term, boost) {
      ...
      function parse_unquoted_term() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_term_start_char();
        if (result0 !== null) {
          result1 = [];
          result2 = parse_term_char();
          while (result2 !== null) {
            result1.push(result2);
            result2 = parse_term_char();
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, term_start, term) {
